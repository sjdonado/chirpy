...
type QueryChirpsParams struct {
	UserID uuid.NullUUID
	Sort   interface{}
}

func (q *Queries) QueryChirps(ctx context.Context, arg QueryChirpsParams) ([]Chirp, error) {
	rows, err := q.db.QueryContext(ctx, queryChirps, arg.UserID, arg.Sort)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
